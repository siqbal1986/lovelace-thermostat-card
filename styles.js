export function cssData(user) {
  ...
  .dial__ring-grip:nth-child(even) {
    fill: rgba(255, 255, 255, 0.7);
    opacity: 0.4;
  }
  .dial--edit .dial__ring-grip,
  .dial--dragging .dial__ring-grip {
    opacity: 0.5;
  }
  .dial--dragging .dial__metal-ring {
    opacity: 1;
  }
  ...
  .dial--dragging .dial__ticks {
    cursor: grabbing;
  }
  .dial--dragging .dial__ticks path {
    cursor: grabbing;
  }
