...
export default class ThermostatUI {
  ...
  _updateCarouselStatusLayout() {
    ...
    const verticalScale = 0.25; // TRIAL MERGE: raise the status clusters by another 20% so they sit level with the toggle's midline.
    ...
    const spacingScale = 2.56; // TRIAL MERGE: spread the preset/fan badges an additional 30% so they flank the toggle.
