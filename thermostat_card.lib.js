...
export default class ThermostatUI {
  ...
  _computeModeMenuGeometry(radius) {
    ...
    const buttonRadius = baseButtonRadius * 0.8; // TRIAL MERGE: shrink the toggle by 20% for the refreshed layout request.
    const bottomOffset = Math.max(0, safeRadius * 0.2 - safeRadius * 0.05); // TRIAL MERGE: drop the toggle 5% lower toward the rim.
